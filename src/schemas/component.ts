...
export const componentSchema = z.object({
    ...
    code: z.string().min(1, "Code must be at least 3 characters"),
    color: z.string().min(1, "Color must be at least 2 characters"),
    ...
    configuration: z.string().min(1, "Configuration must be at least 2 characters"),
    ...
    testMachine: z.string().min(1, "Test machine must be at least 2 characters"),
    ...
    factoryReferenceID: z.string().min(1, "Factory reference ID must be at least 2 characters"),
})